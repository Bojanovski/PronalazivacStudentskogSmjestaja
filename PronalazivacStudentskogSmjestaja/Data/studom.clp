...
(defrule getBlizinaMenze ""
    ...
    (assert (UI-state (display "Blizina studentske menze:")
                ...
                (response No)
                (valid-answers "integrirano" "blizu" "udaljeno" "nije vazno")
                (coded-answers 100 200 300 10000))))  
...
(defrule getTrgovina ""
    ...
    (assert (UI-state (display "Blizina trgovine:")
                ...
                (response No)
                (valid-answers "blizu" "udaljeno" "nije vazno")
                (coded-answers 100 200 10000))))   
...
(vrsta ?vrst)
   ...
   (kupaonica ?kup)
   (or (test (<= ?kup  200)) (test (= 10000 ?kup)) )
   (kuhinja ?kuh)
   (or (test (<= ?kuh 200)) (test (= 10000 ?kuh)) )
   (namjestenost ?namj)
   (or (test (<= ?namj  300)) (test (= 10000 ?namj)) )
   (menza ?menz)
   (or (test (<= ?menz 200)) (test (= 10000 ?menz)) )
   (praonica ?prao)
   (or (test (<= ?prao 200)) (test (= 10000 ?prao)) )
   (trgovina ?trg)
   (or (test (= ?trg  100 )) (test ( = 10000 ?trg)))
   (sport ?spor)
   (or (test (<= ?spor 200)) (test ( = 10000 ?spor)))
   (stanari ?stan)
   (or (test (= ?stan 100)) (test ( = 10000 ?stan)))
   =>
...
(defrule stjepanradick12 ""
   ...
   (or (test (<= ?spor 200)) (test ( = 10000 ?spor)))
   (stanari ?stan)
   (or (test (= ?stan 200)) (test ( = 10000 ?stan)))
   =>
...
(defrule stjepanradick31 ""
   ...
   (kupaonica ?kup)
   (or (test (= ?kup 100)) (test (= 10000 ?kup)) )
   (kuhinja ?kuh)
   (or (test (= ?kuh 100)) (test (= 10000 ?kuh)) )
   (namjestenost ?namj)
   (or (test (<= ?namj 300)) (test (= 10000 ?namj)) )
   (menza ?menz)
   (or (test (<= ?menz 200)) (test (= 10000 ?menz)) )
...
(defrule stjepanradick5 ""
   ...
   (or (test (= ?kuh 100)) (test (= 10000 ?kuh)) )
   (namjestenost ?namj)
   (or (test (<= ?namj 200)) (test (= 10000 ?namj)) )
   (menza ?menz)
   (or (test (<= ?menz 200)) (test (= 10000 ?menz)) )
   (praonica ?prao)
   (or (test (<= ?prao 200)) (test (= 10000 ?prao)) )
...
(defrule antestarcevick51 ""
   ...
   (or (test (<= ?namj 200)) (test (= 10000 ?namj)) )
   (menza ?menz)
   (or (test (= ?menz 300)) (test (= 10000 ?menz)) )
   (praonica ?prao)
   (or (test (<= ?prao 200)) (test (= 10000 ?prao)) )
   (trgovina ?trg)
   (or (test (= ?trg 100)) (test ( = 10000 ?trg)))
...
(defrule lascinak7 ""
   ...
   (or (test (= ?kuh 100)) (test (= 10000 ?kuh)) )
   (namjestenost ?namj)
   (or (test (= ?namj 100)) (test (= 10000 ?namj)) )
   (menza ?menz)
   (or (test (<= ?menz 200)) (test (= 10000 ?menz)) )
   (praonica ?prao)
   (or (test (<= ?prao 200)) (test (= 10000 ?prao)) )
...
(defrule novizagreb ""
   ...
   (or (test (= ?menz 300)) (test (= 10000 ?menz)) )
   (praonica ?prao)
   (or (test (= ?prao 300)) (test (= 10000 ?prao)) )
   (trgovina ?trg)
   (or (test (= ?trg 100)) (test ( = 10000 ?trg)))
   (sport ?spor)
   (or (test (= ?spor 200)) (test ( = 10000 ?spor)))
   (stanari ?stan)
   (or (test (= ?stan 300)) (test ( = 10000 ?stan)))
   =>
